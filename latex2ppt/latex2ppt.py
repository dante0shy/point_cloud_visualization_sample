texfile = r'C:\Users\hanyu001\OneDrive\庶务\qe\slides\template\beamer-example-NTU.tex'
outputfile = r'C:\Users\hanyu001\OneDrive\庶务\qe\slides\template\beamer-example-NTU.pptx'
...
for idslide, slide in enumerate(slides):
    ...
    if len(title) > 0:
        ...
        print
        'add slide %s (%d over %d)' % (title[0], idslide, len(slides))
